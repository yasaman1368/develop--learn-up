    ...
    DateRangePicker.prototype = {
        ...
        renderTimePicker: function (side) {
            ...
            if (!this.timePicker24Hour) {
                ...
                if (selected.hour() >= 12) {
                    html += '<option value="AM"' + am_html + '>ق.ظ</option><option value="PM" selected="selected"' + pm_html + '>ب.ظ</option>';
                } else {
                    html += '<option value="AM" selected="selected"' + am_html + '>ق.ظ</option><option value="PM"' + pm_html + '>ب.ظ</option>';
                }
                html += '</select>';
            }
